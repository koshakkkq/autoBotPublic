...
inline_btn_2 = InlineKeyboardButton('В главное меню ↩', callback_data='menu')
keyboardHelloMailing = InlineKeyboardMarkup(row_width=1).add(inline_btn_1, inline_btn_2)

#readThis
inline_btn_1 = InlineKeyboardButton('Да, готов ✅', callback_data='pay')
...
inline_btn_3 = InlineKeyboardButton('В главное меню ↩️', callback_data='menu')
